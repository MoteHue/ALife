...
def batch_main():
    ...
    with open("ga_output_max_gen_100_to_6400.dat",'w') as f:
        ...
        #for target in ["m", "me", "met", "meth", "methi", "methin", "methink", "methinks", "methinks ", "methinks i", "methinks it", "methinks it ", "methinks it i", "methinks it is"]:
        for t_size in [2, 3, 4, 5, 6]:
            for max_gen in [100, 200, 400, 800, 1600, 3200, 6400]:
                ...
                gens, best = do_the_ga(tournament_size=2, max_gen=max_gen, file=f, write_every=max_gen)
                print("t_size={:1d}, max_gen={:4d}, {:5d} generations yielded: '{}' ({:.3f})".format(t_size, max_gen, gens, best["solution"], best["fitness"]))
            print("")
